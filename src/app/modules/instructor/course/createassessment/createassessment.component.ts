...
@Component({
  ...
  styleUrls: ['./createassessment.component.scss']
})
export class CreateassessmentComponent implements OnInit {
  ...
  addAssessmentFormSubmit() {
    console.log(this.addAssessmentForm.value);
